...
<title>server info <?php echo $version; ?></title>
<style type="text/css">
<!--
* {font-family: Tahoma, "Microsoft Yahei", Arial; }
body{text-align: center; margin: 0 auto; padding: 0; background-color:#DDDDDD;font-size:12px;font-family:Tahoma, Arial}
...
<div id="page">
    <div id="header">
        <h1>server info</h1>
        <div id="download"><A HREF="http://www.duyaofei.com/downloads/tz.zip">tz</A></div>
    </div>
