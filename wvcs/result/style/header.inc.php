			...
			<div class="fill">
				<div class="container">
					...
					<ul>
						...
						<li<?php active('project');?>><a href="<?php echo $after_login_redirect;?>">Group Projects</a></li>
					</ul>
					<form action="task_search.php" method="get">
						<input type="text" name="s" placeholder="search tasks">
					</form>
					<ul class="nav secondary-nav">
						<li<?php active('private');?>><a href="project.php?private=1">My Private Projects</a></li>
